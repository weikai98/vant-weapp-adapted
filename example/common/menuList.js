module.exports = [
  {
    ...
    list: [
      ...
      { path: '/modal', title: 'modal 遮罩' },
      { path: '/button-group', title: 'button-group 按钮组' },
      { path: '/cell-group', title: 'cell-group 单元格组' },
  ...
  { type: 'data', groupName: '展示组件', list: [] },
  { type: 'other', groupName: '其他', list: [] }
]
